...
const bodyContent = [
  ...
  body("Social media functions as a set of building blocks—identity, conversations, sharing, presence, and relationships—and effective campaigns select platforms whose strengths match the organization’s goals (Kietzmann et al., 2011). To avoid duplicating content, each platform in this campaign is assigned a distinct role and creative treatment."),
  ...
  h2("Blog"),
  body("The blog, hosted on shood.org, is the campaign’s content home and search-visible archive. Nonprofits use owned media to provide depth that social platforms cannot, building community and driving action (Lovejoy & Saxton, 2012). Weekly “Sole to Soul” blog posts will tell one long-form story per week—a volunteer profile, a recipient’s journey, the science of proper shoe fit, and a campaign wrap-up—each ending with a clear call to donate, volunteer, or join the Strava challenge. Social posts will tease and link back to the blog, making it the connective tissue of the campaign."),
...
const references = [
  ...
  ref([run("Guidry, J. P. D., Waters, R. D., & Saxton, G. D. (2014). Moving social marketing beyond personal change to social change: Strategically using Twitter to mobilize supporters into vocal advocates. "), run("Journal of Social Marketing, 4", { italics: true }), run("(3), 240–260. https://doi.org/10.1108/JSOCM-02-2014-0014")]),
  ref([run("Kaplan, A. M., & Haenlein, M. (2010). Users of the world, unite! The challenges and opportunities of social media. "), run("Business Horizons, 53", { italics: true }), run("(1), 59–68. https://doi.org/10.1016/j.bushor.2009.09.003")]),
  ref([run("Kietzmann, J. H., Hermkens, K., McCarthy, I. P., & Silvestre, B. S. (2011). Social media? Get serious! Understanding the functional building blocks of social media. "), run("Business Horizons, 54", { italics: true }), run("(3), 241–251. https://doi.org/10.1016/j.bushor.2011.01.005")]),
  ref([run("Lovejoy, K., & Saxton, G. D. (2012). Information, community, and action: How nonprofit organizations use social media. "), run("Journal of Computer-Mediated Communication, 17", { italics: true }), run("(3), 337–353. https://doi.org/10.1111/j.1083-6101.2012.01576.x")]),
